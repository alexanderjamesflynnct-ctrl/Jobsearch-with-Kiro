...
function CountryCell({ job, onUpdated }) {
  ...
  const isUnknown =
    !job.country || job.country === "Unknown" || job.country === "LinkedIn";
          ...
          <>
            ...
            >
              <td>
                ...
                >
                  <span className={`badge badge-${job.source || "adzuna"}`}>
                    {job.source || "adzuna"}
                  </span>
                  {isNew(job.searched_at) && (
              ...
              <td>{job.state || "—"}</td>
              <td>
                <CountryCell job={job} onUpdated={onRefresh} />
              </td>
              <td>
                <div className="type-cell">
                  ...
                  {job.is_remote && (
                    <span
                      className={`badge-remote badge-remote-${job.is_remote.toLowerCase().replace("-", "")}`}
                    >
                      {job.is_remote}
                    </span>
                  )}
